...
#define SERIAL_CONSOLE_PROCEED_WITH_DISPLAY      (true)
/* Flag to prevent displaying data */
#define SERIAL_CONSOLE_DONT_PROCEED_WITH_DISPLAY (false)

/* Size of the buffer for converting float to string */
#define SERIAL_CONSOLE_DTOSTRF_BUFFER_SIZE   (20u)
/* Size for the null terminator in strings */
#define SERIAL_CONSOLE_NULL_TERMINATOR_SIZE  (1u)
/* Minimal size of float string for serial console */
#define SERIAL_CONSOLE_MIN_FLOAT_STRING_LEN  (1u)
/* Len of formated hex address */
#define SERIAL_CONSOLE_HEX_ADDR_STRING_LEN   (3u)
...
/* Defines the threshold value below which a leading zero is added for formatting */
#define SERIAL_CONSOLE_TWO_CIPHER_NUMBER     (10u)
