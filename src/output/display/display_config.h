...
/* Row for displaying error message */
#define DISPLAY_ERROR_CODE_ROW (uint8_t)(0u)
/* Row for displaying component error info */
#define DISPLAY_ERROR_COMPONENT_INFO_ROW (uint8_t)(1u)
