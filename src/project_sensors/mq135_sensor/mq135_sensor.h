...
#define MQ135_SENSOR_R_ZERO                        (uint16_t)(30000u)
...
#define MQ135_SENSOR_SCALING_FACTOR                (float)(10.0f) /* Scaling factor because sensor is giving output which is too low */
