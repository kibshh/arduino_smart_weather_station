...
#define DATA_ROUTER_DISPLAY_SENSORS_PAYLOAD_LEN_MIN              DATA_ROUTER_INPUT_SENSORS_RETURN_LEN
#define DATA_ROUTER_DISPLAY_TIME_PAYLOAD_LEN_MIN                 DATA_ROUTER_INPUT_RTC_RETURN_LEN
#define DATA_ROUTER_DISPLAY_I2C_SCAN_PAYLOAD_LEN_MIN             (2u)
